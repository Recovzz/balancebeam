...
// Initialise l'environnement de test en créant un serveur Echo et un BalanceBeam
...
// Teste le cas simple : ouvrir quelques connexions, chacune avec une seule requête, et vérifier
// que tout est correctement acheminé.
#[tokio::test]
...
// Teste la gestion de plusieurs requêtes HTTP par connexion au serveur. Ouvre trois connexions
// concurrentes et envoie quatre requêtes sur chacune.
#[tokio::test]
